...
/* Addended header file for time measurement, J.V. */
#include <time.h>
                      ...
                      bool last_msg)
{
    ...
    /* End of data transmission measurement  J.V.*/  
    stop = clock();
    double elapsed = (double)(stop - start)  / CLOCKS_PER_SEC;
    printf("\n******************| Salt Encryption |*********************\n");
    printf("Salt channelv2 encryption about the size %u lasted %f second\n", size, elapsed);
                        ...
                        uint32_t *unwrapped_length)
{
    ...
    double elapsed = (double)(stop - start)  / CLOCKS_PER_SEC;
    printf("\n******************| Salt Decryption |*********************\n");
    printf("Salt channelv2 decryption about the size %u lasted %f second\n", size, elapsed);
